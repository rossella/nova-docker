...
class DockerDriverTestCase(test_virt_drivers._VirtDriverTestCase,
    ...
    def _test_start_container_with_network_events(self, neutron_failure=None):
        ...
        drvr = novadocker.virt.docker.driver.DockerDriver(virtapi, False)
        ...
        def test_start(remove_container, kill, attach_vif, plug_vifs):
    ...
    @mock.patch('nova.utils.is_neutron', return_value=True)
    def test_start_container_with_network_events_failed_timeout(
            self, is_neutron):
    ...
    @mock.patch('nova.utils.is_neutron', return_value=True)
    def test_start_container_with_network_events_failed_error(
            self, is_neutron):
        self.assertRaises(exception.InstanceDeployFailure,
                          self._test_start_container_with_network_events,
